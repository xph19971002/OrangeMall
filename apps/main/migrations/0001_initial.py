# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2019-01-24 02:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=255, unique=True, verbose_name='配送地址')),
        ...
        migrations.AddField(
            model_name='order',
            name='shop',
            field=models.ForeignKey(db_column='shop_id', on_delete=django.db.models.deletion.DO_NOTHING, related_name='shop_order', to='main.Shop', verbose_name='商品ID'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
            field=models.ForeignKey(db_column='uid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_order', to=settings.AUTH_USER_MODEL, verbose_name='用户ID'),
        ),
        migrations.AddField(
            model_name='image',
            name='shop',
